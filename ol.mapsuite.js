...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__source_geoVectorTileSource__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__geoVectorTile__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__style_geoStyle__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__format_geoMvt__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__styleJsonCache__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__styleJsonCacheItem__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__render_geoVectorTilelayerRender__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__tree_TreeNode__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__tree_tree__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__worker_workerManager__ = __webpack_require__(30);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var VectorTileLayer = /** @class */ (function (_super) {
    ...
    function VectorTileLayer(styleJson, opt_options) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_0__util__["a" /* Util */].isStyleJsonUrl(styleJson)) {
    ...
    VectorTileLayer.prototype.loadStyleJson = function (styleJson) {
        ...
        this.geoSources = {};
        // for (let sourceJson of styleJson["sources"]) {
        ...
        if (styleJson["layers"] && styleJson["layers"].length > 0) {
            ...
            if (source) {
                ...
                if (this.background) {
                    var backgroundColor = __WEBPACK_IMPORTED_MODULE_3__style_geoStyle__["a" /* GeoStyle */].toRGBAColor(this.background);
                    if (backgroundColor) {
                ...
                var styleJsonCache = new __WEBPACK_IMPORTED_MODULE_5__styleJsonCache__["a" /* StyleJsonCache */]();
                var styleIdIndex = 0;
                for (var _i = 0, styleIds_1 = styleIds; _i < styleIds_1.length; _i++) {
                    ...
                    if (styleJson_1) {
                        ...
                        var item = new __WEBPACK_IMPORTED_MODULE_6__styleJsonCacheItem__["a" /* StyleJsonCacheItem */](styleJson_1, minZoom, maxZoom, layerName);
                        for (var zoom = item.minZoom; zoom <= item.maxZoom; zoom++) {
                            var treeNode = new __WEBPACK_IMPORTED_MODULE_8__tree_TreeNode__["a" /* TreeNode */](item);
                            this.createChildrenNode(treeNode, item, zoom);
                            styleJsonCache.add(zoom, item.dataLayerName, new __WEBPACK_IMPORTED_MODULE_9__tree_tree__["a" /* Tree */](treeNode, styleIdIndex));
                        }
                        styleIdIndex += 1;
                    }
                }
                ...
                if (this.isMultithread) {
                    if (this.workerManager) {
                        ...
                        this.workerManager.postMessage(ol.getUid(messageData), "initStyleJSON", messageData, undefined, undefined);
                    }
                }
            }
        }
    ...
    VectorTileLayer.prototype.getGeoSource = function (sourceId) {
        ...
        if (this.styleJson["sources"]) {
            for (var _i = 0, _a = this.styleJson["sources"]; _i < _a.length; _i++) {
    ...
    VectorTileLayer.prototype.createVectorTileSource = function (sourceJson) {
        if (sourceJson["type"] === "MVT") {
            ...
            var source = new __WEBPACK_IMPORTED_MODULE_1__source_geoVectorTileSource__["a" /* GeoVectorTileSource */]({
                tileClass: __WEBPACK_IMPORTED_MODULE_2__geoVectorTile__["a" /* GeoVectorTile */],
                url: sourceJson["url"],
    ...
    VectorTileLayer.prototype.getVectorSourceFormat = function () {
        var format = new __WEBPACK_IMPORTED_MODULE_4__format_geoMvt__["a" /* GeoMVTFormat */](undefined, { multithread: this.isMultithread, minimalist: false });
        if (this.isMultithread) {
            if (!this.workerManager || !this.workerManager.inited) {
                this.workerManager = new __WEBPACK_IMPORTED_MODULE_10__worker_workerManager__["a" /* WorkerManager */]();
        ...
        if (item.subStyleCacheItems && item.subStyleCacheItems.length > 0) {
            for (var i = 0, ii = item.subStyleCacheItems.length; i < ii; i++) {
                ...
                if (zoom >= subStyleItem.minZoom && zoom <= subStyleItem.maxZoom) {
                    var node = new __WEBPACK_IMPORTED_MODULE_8__tree_TreeNode__["a" /* TreeNode */](subStyleItem);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vectorTileLayer__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__worldStreetsVectorTileLayer__ = __webpack_require__(31);


ol.mapsuite = {};
ol.mapsuite["VectorTileLayer"] = __WEBPACK_IMPORTED_MODULE_0__vectorTileLayer__["a" /* VectorTileLayer */];
ol.mapsuite["WorldStreetsVectorTileLayer"] = __WEBPACK_IMPORTED_MODULE_1__worldStreetsVectorTileLayer__["a" /* WorldStreetsVectorTileLayer */];
window["ol"] = ol;
                ...
                if (format.isMultithread && format.workerManager) {
                    ...
                    var loadedCallback = function (data, methodInfo) {
                        ...
                        for (var i = 0; i < tileLoadEventInfos.length; i++) {
                            ...
                            // loadEventInfo.tile.workerIndex = methodInfo.workerIndex; // Currently, we just one web worker for one layer.
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__style_geoAreaStyle__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__style_geoLineStyle__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__style_geoPointStyle__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__style_geoTextStyle__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__style_geoBrush__ = __webpack_require__(19);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var GeoPointStyle = /** @class */ (function (_super) {
    ...
    GeoPointStyle.prototype.getGlyphImage = function (textState) {
        ...
        this.drawMask(context, 0, 0, renderWidth * scale, renderHeight * scale);
        context.font = font;
    ...
    GeoPointStyle.prototype.drawRectangle = function (context, x, y, width, height, fill, stroke) {
        if (fill) {
            ...
            context.fillRect(x + stroke.getWidth(), y + stroke.getWidth(), width, height);
        }
        if (stroke) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__geoStyle__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__geoStyleProperty__ = __webpack_require__(23);
...
var GeoVectorTileLayerRender = /** @class */ (function (_super) {
    ...
    GeoVectorTileLayerRender.prototype.createReplayGroup_ = function (tile, frameState) {
        ...
        var _loop_1 = function (t, tt) {
            ...
            if (source.isMultithread) {
                sourceTile.state = ol.TileState.ERROR;
                var render = this_1;
                ...
                var messageData = [
                    [0, tileExtent, resolution, pixelRatio, source.getOverlaps(), this_1.declutterTree_, layer.getRenderBuffer(), false],
                ...
                var callabck = function (replaysByZIndex_) {
                    ...
                    replayState.renderedTileLoadind = false;
                    sourceTile.state = ol.TileState.LOADED;
                    tile.setState(ol.TileState.LOADED);
                };
                source.getGeoFormat().workerManager.postMessage(sourceTile.tileCoord + ol.getUid(callabck), "createReplay", messageData, callabck, sourceTile.workerIndex);
                replayState.renderedRevision = revision;
                replayState.renderedTileLoadind = true;
            }
            else {
    ...
    GeoVectorTileLayerRender.prototype.renderTileImageCustom = function (tile, frameState, layerState) {
        ...
        if (replays && !replayState.renderedTileLoadind && replayState.renderedTileRevision !== revision) {
...
var WorkerManager = /** @class */ (function () {
    ...
    WorkerManager.prototype.initWorkers = function () {
        try {
            ...
            // this.worker = new Worker("worker.0.js");
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WorldStreetsVectorTileLayer; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vectorTileLayer__ = __webpack_require__(4);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var WorldStreetsVectorTileLayer = /** @class */ (function (_super) {
    __extends(WorldStreetsVectorTileLayer, _super);
    function WorldStreetsVectorTileLayer(styleJson, opt_options) {
        return _super.call(this, styleJson, opt_options) || this;
    }
    WorldStreetsVectorTileLayer.prototype.getGeoSource = function (sourceId) {
        var defaultUrl = 'http://54.219.163.231/data/v/{z}/{x}/{y}.pbf';
        var url = this.apiKey ? (defaultUrl + '?apiKey=' + this.apiKey) : defaultUrl;
        url = this.proxy ? (this.proxy + encodeURIComponent(defaultUrl)) : url;
        var sourceJSON = {
            "url": url,
            "type": "MVT"
        };
        var source = this.createVectorTileSource(sourceJSON);
        return source;
    };
    return WorldStreetsVectorTileLayer;
}(__WEBPACK_IMPORTED_MODULE_0__vectorTileLayer__["a" /* VectorTileLayer */]));
